                    ...
                    {link.children.map((child) => (
                      <Link
                        ...
                        className={`block px-4 py-2.5 text-sm transition-colors ${
                          pathname === child.path ? 'text-primary bg-primary/5 font-medium' : 'text-gray-600 hover:text-primary hover:bg-gray-50'
                        }`}
                      >
                        {child.label}
                      </Link>
                    ...
                    <>
                      ...
                      {activeDropdown === link.path && (
                        <div className="ml-4 flex flex-col gap-1 mt-1">
                          <Link href="/services" className="px-4 py-2.5 text-sm text-gray-600 hover:text-primary rounded-lg hover:bg-gray-50">
                            All Services
                          </Link>
                          {link.children.map((child) => (
                            <Link
